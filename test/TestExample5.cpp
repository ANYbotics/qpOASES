...
/**
 *	\file test/cpp/TestExample5.cpp
 ...
 *	Example illustrating the use of the \a ConstraintProduct class.
 */
class MyConstraintProduct : public qpOASES::ConstraintProduct {
  using int_t = qpOASES::int_t;
...
TEST(TestExamle5, SQProblemWithUserDefinedConstraintProductFunction) {  // NOLINT
