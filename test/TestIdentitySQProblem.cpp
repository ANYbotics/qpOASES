...
TEST(TestIdentitySQProblem, SQProblem) {  // NOLINT
  ...
  ASSERT_NEAR(xOpt[0], 0., 1e-10);
  ASSERT_NEAR(xOpt[1], 0., 1e-10);
  ASSERT_NEAR(xOpt[2], 0., 1e-10);
  ASSERT_NEAR(xOpt[3], 0., 1e-10);
  ASSERT_NEAR(xOpt[4], 0., 1e-10);
  ASSERT_NEAR(xOpt[5], 0., 1e-10);
  ASSERT_NEAR(xOpt[6], 0., 1e-10);
  ...
  joints_velocities.getPrimalSolution( xOpt );
  printf( "\nxOpt = [ %e, %e, %e, %e, %e, %e, %e ];  objVal = %e\n\n", xOpt[0],xOpt[1], xOpt[2],xOpt[3], xOpt[4],xOpt[5], xOpt[6], joints_velocities.getObjVal() );
  ASSERT_NEAR(xOpt[0], -0.2, 1e-1);
  ASSERT_NEAR(xOpt[1], 0.4, 1e-1);
  ASSERT_NEAR(xOpt[2], 0.8, 1e-1);
  ASSERT_NEAR(xOpt[3], 0.8, 1e-1);
  ASSERT_NEAR(xOpt[4], -0.4, 1e-1);
  ASSERT_NEAR(xOpt[5], 0.4, 1e-1);
  ASSERT_NEAR(xOpt[6], 0.4, 1e-1);
}
