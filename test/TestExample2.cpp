...
/**
 *	\file test/cpp/TestExample2.cpp
...
TEST(TestExamle2, SolutionAnalysis) {  // NOLINT
  ...
  ASSERT_LT(maxKktViolation, 1e-15);
  ...
  ASSERT_LT(maxKktViolation, 2e-15);
  ...
  ASSERT_NEAR(Primal_Dual_Var[3 * 5 + 3], 26.0, 1e-10);
}